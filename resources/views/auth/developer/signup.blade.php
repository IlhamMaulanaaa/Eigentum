...
<body>
    <div class="container">
        ...
        <form method="post" action="/session/auth/developer/signup/create" enctype="multipart/form-data">
            @csrf
            <div class="form first">
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" class="form-control noscroll @error('email') is-invalid @enderror"
                        ...
                        <div class="input-field">
                            ...
                            <input type="password" class="form-control noscroll @error('password') is-invalid @enderror"
                ...
                <div class="details ID" style="margin-top: 190px;">
                ...
                <div class="details address">
                    ...
                    <div class="fields">
                        <div class="input-field">
                            ...
                            <input type="text" class="form-control noscroll @error('company') is-invalid @enderror"
                        ...
                        <div class="input-field">
                            ...
                            <select required class="form-select" name="provinces_id" id="provinsi"
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" class="form-control noscroll @error('address') is-invalid @enderror"
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" class="form-control noscroll @error('telp') is-invalid @enderror"
