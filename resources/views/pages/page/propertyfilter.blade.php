...
<div class="fables-header fables-after-overlay">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color">Filter Properti</h2>
    </div>
</div>  
<!-- /End Header -->
    ...
    <div class="container"> 
        <div aria-label="breadcrumb">
          <ol class="fables-breadcrumb breadcrumb px-0 py-3">
            <li class="breadcrumb-item"><a href="#" class="fables-second-text-color" style="text-decoration: none;">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page" style="text-decoration: none;">Filter Properti</li>
          </ol>
        </div> 
    </div>
</div>
     ...
     <div class="row my-4 my-md-5">
           <div class="col-12 col-md-4 col-lg-3">
               ...
               <div class="rage-slider">
                    <h2 class="font-16 semi-font fables-forth-text-color fables-light-gary-background  p-3 mb-4">Filter Harga</h2> 
                    <form> 
                         <!-- <div class="range-slider fables-forth-text-color" id="facet-price-range-slider" data-options='{"output":{"prefix":""},"maxSymbol":"+"}'>
                             <input name="range-1" value="10" min="0" max="10000" step="1" type="range">
                             <input name="range-2" value="10000" min="0" max="10000" step="1" type="range">
                         </div>  -->
                         <div class="price-input">
                            <div class="field" style="margin-right: 10px;">
                              <span>Rp.</span>
                              <input type="text" placeholder="Min" class="input-min" id="inputMin" value="">
                            </div>
                            <div class="field">
                              <span>Rp.</span>
                              <input type="text" placeholder="Max" class="input-max" id="inputMax" value="">
                            </div>
                          </div>
                    </form>
               </div>
                           ...
                           <form> 
                            <div class="form-group mb-0"> 
                                <select class="form-control rounded-0">
                                    ...
                                    <option value="luas-terkecil">Luas Terkecil</option>
                                    <option value="luas-terbesar">Luas Terbesar</option>
                                </select>
