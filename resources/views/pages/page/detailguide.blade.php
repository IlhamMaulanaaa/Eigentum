...
<div class="fables-header fables-after-overlay bg-rules">
    <div class="container"> 
         <h2 class="fables-page-title fables-second-border-color wow fadeInLeft" data-wow-duration="1.5s">Panduan KPR</h2>
    </div>
</div>  
<!-- /End Header -->
     ...
     <div class="my-4 my-lg-5">
        {{-- <div class="owl-carousel owl-theme default-carousel absolute-dots inside-text-carousel nav-0 mr-4 mb-3"> 
         ...
         <p class="fables-forth-text-color font-14">
          Ketika Anda ingin membeli rumah dengan pembayaran KPR, Anda akan menyerahkan sejumlah dokumen persyaratan kepada pihak bank. Setelah itu, bank akan melakukan analisis terhadap data dan keuangan Anda. Hal ini termasuk wawancara, survei keabsahan diri seperti alamat rumah, pekerjaan, dan referensi keluarga. Pihak bank juga akan melakukan proses penilaian dan kalkulasi harga properti yang Anda ajukan.</p>
         <p class="fables-forth-text-color font-14">
     ...
     <div class="wrappertimeline">
        ...
        <div class="row row-1">
          <section>
            ...
            <p>Pertama, pilihlah bank atau lembaga keuangan yang akan Anda ajukan KPR. Pastikan Anda membandingkan berbagai pilihan bank untuk mendapatkan suku bunga dan persyaratan pinjaman yang sesuai dengan kebutuhan Anda.</p>
        ...
        <div class="row row-1">
          <section>
            ...
            <p>Setelah Anda menyiapkan semua dokumen yang diperlukan, ajukan KPR ke bank yang Anda pilih. Bank akan mengevaluasi aplikasi Anda berdasarkan kelayakan kredit dan kemampuan pembayaran Anda.</p>
        ...
        <div class="row row-2">
          <section>
            ...
            <p>Jika Anda mengajukan KPR untuk pembelian properti, bank akan melakukan penilaian properti untuk menentukan nilai riil properti yang akan dijadikan jaminan KPR.</p>
        ...
        <div class="row row-1">
          <section>
            ...
            <p>Bank akan melakukan analisis kredit untuk menilai risiko pemberian kredit kepada Anda. Mereka akan memeriksa profil kredit, kestabilan keuangan, dan kapasitas pembayaran Anda.</p>
        ...
        <div class="row row-2">
          <section>
            ...
            <p>Jika aplikasi Anda disetujui, Anda akan mendapatkan Surat Persetujuan Prinsip Kredit (SP3K). SP3K berisi persetujuan awal dari bank untuk memberikan kredit dengan jumlah tertentu berdasarkan analisis kredit awal. SP3K ini seringkali menjadi syarat utama untuk memproses selanjutnya, seperti akta notaris atau pembebasan hak tanggungan.</p>
        ...
        <div class="col-12 col-md-6 col-lg-4 wow fadeInLeft" data-wow-delay=".8s"> 
             <div class="latest-news-img-block" style="background-image:url(assets/custom/images/post-1.jpg);background-size: cover">
                  <p class="latest-news-text fables-testimonial-detail fables-main-color-transparent italic text-white font-14 text-center p-6">
                     Di balik setiap SP3K terdapat kisah perjuangan dan kerja keras untuk meraih tujuan finansial yang lebih baik.
                 </p>
             </div> 
        </div>
        <div class="col-12 col-md-6 col-lg-8 wow fadeInRight" data-wow-delay=".8s"> 
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-5 col-md-12 col-lg-3">
                    <span class="float-sm-right font-14 italic fables-second-text-color mt-3">09 November, 2018</span>
                </div>
            </div> 
   ...
   <div class="row mb-lg-4">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 wow fadeIn" data-wow-delay=".4s">
            <div class="img-contain image-container rotateOut-effect" style="background-color: #0C40E8;"> 
                ...
                <div class="fables-blog-details-overlay fables-second-color-transparent p-3 d-flex flex-column justify-content-end align-items-center" style="background-color: rgba(12, 64, 232, 0.5);">  
                    <h2 class="mt-6 border-bottom font-18 semi-font pb-2"><a href="#" class="white-color white-color-hover">Lorem ipsum dolor</a></h2> 
