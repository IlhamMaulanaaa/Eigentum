                                                    ...
                                                    <div class="product-m">
                                                        ...
                                                        <div class="product-m__content">
                                                            ...
                                                            <div class="product-m__name">
                                                                ...
                                                                <a href="product-detail.html">{{ $unit->title }}</a>
                                                            </div>

                                                            <div class="product-m__price">Rp. {{ $unit->price }}</div>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="check-box">
                                                        ...
                                                        <div class="check-box__state check-box__state--primary">
                                                            ...
                                                            <label class="check-box__label" for="xs">Dijual</label>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="check-box">
                                                        ...
                                                        <div class="check-box__state check-box__state--primary">
                                                            ...
                                                            <label class="check-box__label" for="small">Disewa</label>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="check-box">
                                                        ...
                                                        <div class="check-box__state check-box__state--primary">
                                                            ...
                                                            <label class="check-box__label" for="small">Rumah</label>
                                                        </div>
                                                    </div>
                                                    <!--====== End - Check Box ======-->
                                                ...
                                                <li>
                                                    ...
                                                    <div class="check-box">
                                                        ...
                                                        <div class="check-box__state check-box__state--primary">
                                                            ...
                                                            <label class="check-box__label" for="small">Ruko</label>
                                                        </div>
                                                    </div>
                                                    <!--====== End - Check Box ======-->
                                                ...
                                                <li>
                                                    ...
                                                    <div class="check-box">
                                                        ...
                                                        <div class="check-box__state check-box__state--primary">
                                                            ...
                                                            <label class="check-box__label" for="small">Villa</label>
                                                        </div>
                                                    </div>
                                                    <!--====== End - Check Box ======-->
