    ...
    <div class="container"> 
        <div aria-label="breadcrumb">
          <ol class="fables-breadcrumb breadcrumb px-0 py-3">
            <li class="breadcrumb-item"><a href="#" class="fables-second-text-color" style="text-decoration: none;">Langganan</a></li>
            <li class="breadcrumb-item active" aria-current="page" style="text-decoration: none;">Konfirmasi Pembayaran</li>
          </ol>
        </div> 
    </div>
</div>
			...
			<div class="row order_d_inner">
				<div class="col-lg-4">
					<div class="details_item">
						...
						<ul class="list">
							<li><a href="#"><span>Nama</span> : Putra Wicaksono</a></li>
							<li><a href="#"><span>Tanggal</span> : 02/09/2023</a></li>
							<li><a href="#"><span>Total</span> : Rp 50.000.00</a></li>
