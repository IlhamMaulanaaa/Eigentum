                                    ...
                                    <div class="dash__box dash__box--bg-white dash__box--shadow u-s-m-b-30">
                                        <div class="dash__pad-1">
                                            ...
                                            <ul class="dash__f-list">
                                                ...
                                                <li>
                                                    <a class="tab-link" data-tab="profileowner" href="javascript:void(0);" onclick="openTab('profileowner')">Profile Owner</a>
                                                </li>
                                                <li>
                                ...
                                <div class="col-lg-9 col-md-12">
                                    <div id="account" class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white u-s-m-b-30">
                                        ...
                                        <div id="orders" class="dash__box dash__box--shadow dash__box--bg-white dash__box--radius" style="display: none;">
                                            ...
                                            <div id="profileowner" class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white">
                                                <div class="dash__pad-2">
                                                            ...
                                                            <form class="dash-edit-p">
                                                                <div class="gl-inline">
                                                                    <div class="u-s-m-b-30">
                                                                        ...
                                                                        <label class="gl-label" for="reg-fname">FOTO</label>
        
                                                                        <img src="/assets/pages/home/kota.jpg" alt="" style="width: 100px; height: 100px;"></div>

                                                                        <div class="u-s-m-b-30">
        
                                                                            <label class="gl-label" for="reg-fname">KTP</label>
            
                                                                            <img src="" alt="" style="width: 100px; height: 100px;"></div>
                                                                </div>
                                                                <div class="gl-inline">
                                                                    <div class="u-s-m-b-30">
                                                            ...
                                                            <form class="dash-edit-p">
                                                                    ...
                                                                    <div class="u-s-m-b-30">
                                                                        ...
                                                                        @if ($developer->face)
                                                                                <img src="{{ asset('storage/' . $developer->face) }}"
                                                                                    alt="{{ $developer->face }}" style="width: 100px; height:100px;">
                                                                        @endif
                                                                        ...
                                                                        <div class="u-s-m-b-30">
                                                                            ...
                                                                            @if ($developer->ktp)
                                                                                    <img src="{{ asset('storage/' . $developer->ktp) }}"
                                                                                        alt="{{ $developer->ktp }}"  style="width: 100px; height:100px;">
                                                                            @endif
                                                                ...
                                                                <div class="gl-inline">
                                                                    <div class="u-s-m-b-30">
                                                                        ...
                                                                        <label class="gl-label" for="reg-fname">PERUSAHAAN</label>
        
                                                                        <input class="input-text input-text--primary-style" type="text" name="company"
                                                                        value="{{ old('company', $developer->company) }}"></div>
                                                                    <div class="u-s-m-b-30">
                                                                        ...
                                                                        value="{{ old('telp', $developer->telp) }}"></div>
                                                                </div>
                                                                <div class="gl-inline">
                                                                    <div class="u-s-m-b-30">
                                                                ...
                                                                <div class="gl-inline">
                                                                    <div class="u-s-m-b-30">
                                                                        ...
                                                                        <label class="gl-label" for="reg-fname">NOMOR POKOK WAJIB PAJAK</label>
        
                                                                        <img src="" alt="" style="width: 100px; height: 100px;"></div>

                                                                        <div class="u-s-m-b-30">
        
                                                                            <label class="gl-label" for="reg-fname">SERTIFIKAT BADAN USAHA</label>
            
                                                                            <img src="" alt="" style="width: 100px; height: 100px;"></div>

                                                                        <div class="u-s-m-b-30">
        
                                                                            <label class="gl-label" for="reg-fname">NOMOR INDUK BERUSAHA</label>
