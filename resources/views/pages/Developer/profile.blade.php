                                        ...
                                        <div class="dash__box dash__box--bg-white dash__box--shadow u-s-m-b-30">
                                            <div class="dash__pad-1">
                                                ...
                                                <ul class="dash__f-list">
                                                    ...
                                                    <li>
                                                        <a class="tab-link" data-tab="profilepribadi"
                                                            href="javascript:void(0);"
                                                            onclick="openTab('profilepribadi')">Profile Pribadi</a>
                                                    </li>
                                                    <li>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="dash__pad-3">
                                                                ...
                                                                <div class="dash__link dash__link--secondary u-s-m-t-8">
                                                                    <a data-modal="modal"
                                                                        data-modal-id="#dash-newsletter">Telah
                                                                        Berlangganan</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-4 u-s-m-b-30">
                                                        <div
                                                            ...
                                                            <div class="dash__pad-3">
                                                                ...
                                                                <div class="dash__link dash__link--secondary u-s-m-b-8">
                                                                    <a data-tab="profilepribadi" href="javascript:void(0);"
                                                                        onclick="openTab('profilepribadi')">Edit</a>
                                                                </div>
                                                                <span class="dash__text">Suparjono</span>
                                                                <span class="dash__text">suparjono90@gmail.com</span>
                                                                <div class="dash__link dash__link--secondary u-s-m-t-8">
                                                    ...
                                                    <div class="col-lg-4 u-s-m-b-30">
                                                        <div
                                                            ...
                                                            <div class="dash__pad-3">
                                                                ...
                                                                <span class="dash__text">Kudus, Jawa Tengah, Desa Besito,
                                                                    Kec. Gebog</span>
                                                        ...
                                                        <form class="dash-edit-p">
                                                            <div class="gl-inline">
                                                                <div class="u-s-m-b-30">
                                                                    ...
                                                                    <img src="/assets/pages/home/kota.jpg" alt=""
                                                            ...
                                                            <div class="gl-inline">
                                                                <div class="u-s-m-b-30">
                                                                    ...
                                                                    <input class="input-text input-text--primary-style"
                                                                        type="text" id="reg-fname" placeholder="John">
                                                                </div>
                                                                <div class="u-s-m-b-30">
                                                                    ...
                                                                    <input class="input-text input-text--primary-style"
                                                                        type="text" id="reg-lname" placeholder="Doe">
                                                                </div>
