        ...
        <div class="form-container" style="margin-top: 90px; height:auto;">
            ...
            <div class="left-section">
                <form method="post" action="{{ route('unit.update.developer', $unit->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group row g-2">
                                <div class="col-auto">
                                    ...
                                    @foreach ($livingroomImgs as $index => $livingroomImg)
                                        <div class="image-container my-2">
                                            <img src="{{ asset('storage/' . $livingroomImg) }}" alt="{{ $livingroomImg }}"
                                ...
                                <div class="livingroomimg row g-2">
                                    <div class="col-auto">
                                        <input type="file" class="form-control noscroll" id="livingroomimg_insert"
                                            name="livingroomimg_insert[]" multiple>
                                    </div>
                            ...
                            <div class="form-group row g-2">
                                <div class="col-auto">
                                    ...
                                    @foreach ($bedroomImgs as $index => $bedroomImg)
                                        <div class="image-container my-2">
                                            <img src="{{ asset('storage/' . $bedroomImg) }}" alt="{{ $bedroomImg }}"
                                                class="img-thumbnail" width="200">
                                        </div>
                                        <input type="file" class="form-control noscroll"
                                ...
                                <div class="bedroomimg row g-2">
                                    <div class="col-auto">
                                        <input type="file" class="form-control noscroll" id="bedroomimg_insert"
                                            name="bedroomimg_insert[]" multiple>
                                    </div>
                                    <div class="input-group-btn col-auto">
                            ...
                            <div class="form-group row g-2">
                                <div class="col-auto">
                                    ...
                                    @foreach ($bathroomImgs as $index => $bathroomImg)
                                        <div class="image-container my-2">
                                            <img src="{{ asset('storage/' . $bathroomImg) }}" alt="{{ $bathroomImg }}"
                                                class="img-thumbnail" width="200">
                                        </div>
                                        <input type="file" class="form-control noscroll"
                                ...
                                <div class="bathroomimg row g-2">
                                    <div class="col-auto">
                                        <input type="file" class="form-control noscroll" id="bathroomimg_insert"
                                            name="bathroomimg_insert[]" multiple>
                                    </div>
                                    <div class="input-group-btn col-auto">
                            ...
                            <div class="form-group row g-2">
                                <div class="col-auto">
                                    ...
                                    @foreach ($kitchenImgs as $index => $kitchenImg)
                                        <div class="image-container my-2">
                                            <img src="{{ asset('storage/' . $kitchenImg) }}" alt="{{ $kitchenImg }}"
                                                class="img-thumbnail" width="200">
                                        </div>
                                        <input type="file" class="form-control noscroll"
                                ...
                                <div class="kitchenimg row g-2">
                                    <div class="col-auto">
                                        <input type="file" class="form-control noscroll" id="kitchenimg_insert"
                                            name="kitchenimg_insert[]" multiple>
                                    </div>
                                    <div class="input-group-btn col-auto">
                            ...
                            <div class="form-group row g-2">
                                <div class="col-auto">
                                    ...
                                    @foreach ($etcImgs as $index => $etcImg)
                                        <div class="image-container my-2">
                                            <img src="{{ asset('storage/' . $etcImg) }}" alt="{{ $etcImg }}"
                                                class="img-thumbnail" width="200">
                                        </div>
                                        <input type="file" class="form-control noscroll"
                                ...
                                <div class="etcimg row g-2">
                                    <div class="col-auto">
                                        <input type="file" class="form-control noscroll" id="etcimg_insert"
                                            name="etcimg_insert[]" multiple>
                                    </div>
                                    <div class="input-group-btn col-auto">
                    ...
                    <br>
                    <div class="float-end">
                        <a type="button" class="btn btn-warning" href="{{ route('unit.show', $unit->id) }}">Back</a>
                        <button type="submit" class="btn btn-primary">Submit</button>
                    </div>

                    <select name="statuscode">
                        <option value="proses penawaran">proses penawaran</option>
