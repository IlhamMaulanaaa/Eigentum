...
<head>
    ...
    <!-- Swiper CSS -->
    <link rel="stylesheet" href="css/swiper-bundwle.min.css">
...
<body>
    ...
    <div class="container-fluid bg-custom mb-5 wow fadeIn" data-wow-delay="0.1s" style="padding: 35px; background-color: #0C40E8; margin-top: 400px;">
      <div class="container">
          <div class="row g-2">
                  ...
                  <div class="row g-2">
                      ...
                      <div class="col-md-4">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control border-0 py-3" placeholder="Lokasi Spesifik">
                        </div>
                      </div>
              ...
              <div class="col-md-2">
                  <button class="btn btn-dark border-0 w-100 py-3 btn-white">Search</button>
              </div>
  ...
  <!-- Search End -->
        ...
        <div class="daftar-rumah-baru-ALP" id="4:7200">Apartemen</div>
    ...
    <div class="frame-156-pto" id="4:7196">
        ...
        <div class="frame-156-pto" id="4:7196">
            <div class="group-77-FDR" id="4:7198">
            <div class="daftar-rumah-baru-ALP1" id="4:7200">Properti Rumah</div>
        ...
        <div class="frame-156-pto" id="4:7196">
          <div class="group-77-FDR" id="4:7198">
          <div class="daftar-rumah-baru-ALP2" id="4:7200">Properti Ruko</div>
        ...
        <div class="frame-156-pto" id="4:7196">
          <div class="group-77-FDR" id="4:7198">
          <div class="daftar-rumah-baru-ALP2" id="4:7200">Properti Villa</div>
