        ...
        <div class="divstyle_programs__TLWft">
            <div class="npmren row row-cols-1 row-cols-md-3 g-4">
                <div class="col">
                    <div class="card h-100 shadow bg-body rounded border-0">
                        <span class="input-group-text border-0" id="inputGroupPrepend">
                            <img src="/assets/kpr/Frame 481.png" alt="">
                        </span>
                ...
                <div class="col">
                    <div class="card h-100 shadow bg-body rounded border-0">
                        <span class="input-group-text border-0" id="inputGroupPrepend">
                            <img src="/assets/kpr/mandiray.png" alt="">
                        </span>
                        <div class="card-body border-0"
                            style="display: flex; flex-direction: column;  align-items: center; padding-top: -100px;">
                ...
                <div class="col">
                    <div class="card h-100 shadow bg-body rounded border-0">
                        <span class="input-group-text border-0" id="inputGroupPrepend">
                            <img src="/assets/kpr/Frame 479.png" alt="">
                        </span>
                        <div class="card-body border-0"
                            style="display: flex; flex-direction: column;  align-items: center; padding-top: -100px;">
    ...
    <div class="sectionkpr-bank ">
        <div class="row helper">
            <div class="northem col-md-6">
                ...
                <p class="cdcdcd col-md-7  text-start">Daftar bank dengan bunga KPR terbaik.</p>
            </div>
        ...
        <div class="cuaks row">
            ...
            <div class="divbg-white">
                <div class="logo d-flex align-items-center justify-content-start ">
                    <img class="yuhuuu" src="/assets/kpr/btn.png" alt="">
                    <h6>Bank BTN</h6>
                </div>
            ...
            <div class="divbg-white">
                <div class="logo d-flex align-items-center justify-content-start ">
                    <img class="yuhuuu" src="/assets/kpr/bni.png" alt="">
                    <h6>Bank BNI</h6>
                </div>
                <div class="row jadisatu">
                    <div class="infoSukuBunga d-flex col-md-5">
            ...
            <div class="divbg-white">
                <div class="logo d-flex align-items-center justify-content-start ">
                    <img class="yuhuuu" src="/assets/kpr/mandiri.png" alt="">
                    <h6>Bank Mandiri</h6>
                </div>
                <div class="row jadisatu">
                    <div class="infoSukuBunga d-flex col-md-5">
        ...
        <div class="cuaks row">
            ...
            <div class="divbg-white">
                <div class="logo d-flex align-items-center justify-content-start ">
                    <img class="yuhuuu" src="/assets/kpr/bri.png" alt="">
                    <h6>Bank BRI</h6>
                </div>
                <div class="row jadisatu">
                    <div class="infoSukuBunga d-flex col-md-5">
            ...
            <div class="divbg-white">
                <div class="logo d-flex align-items-center justify-content-start ">
                    <img class="yuhuuu" src="/assets/kpr/ocbc nisp.png" alt="">
            ...
            <div class="divbg-white">
                <div class="logo d-flex align-items-center justify-content-start ">
                    <img class="yuhuuu" src="/assets/kpr/permata bank.png" alt="">
                    <h6>Bank Permata</h6>
                </div>
                <div class="row jadisatu">
                    <div class="infoSukuBunga d-flex col-md-5">
