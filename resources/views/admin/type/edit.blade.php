...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-ad-12">
                <h3 align="center" class=" text-light">Edit Data Type</h3>
                <br>
                    ...
                    <div class="card-body">
                        <form method="post" action="/admin/type/update/ {{ $type->id }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="housing" name="housing" value="{{ old('housing', $type->housing) }}" required>
                            </div>
                            <br>
                            <div class="form-group">
                                <label for="apartement" class="form-label">Apartement</label>
                                <input type="text" class="form-control" id="apartement" name="apartement" value="{{ old('apartement', $type->apartement) }}" required>
                            </div>
                            <br>
                            <div class="form-group">
                                <label for="villa" class="form-label">Villa</label>
                                <input type="text" class="form-control" id="villa" name="villa" value="{{ old('villa', $type->villa) }}" required>
                            </div>
                            <!--
                            <div class="form-group">
