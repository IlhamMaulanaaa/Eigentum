                        ...
                        <form method="post" action="/admin/developer/add" enctype="multipart/form-data">
                            ...
                            <div class="form-group owner">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control noscroll" id="email" name="owner_email">
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="password" class="form-label">Password</label>
                                    <input type="password" class="form-control noscroll" id="password" name="owner_password">
                                </div>
                                <br>
                                <div class="form-group">
                            ...
                            <div class="form-group developer">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control noscroll" id="license_nib" name="license[]"
                                        multiple>
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="npwp" class="form-label">Nomor Pokok Wajib Pajak</label>
                                    <input type="file" class="form-control noscroll" id="license_npwp" name="license[]"
                                        multiple>
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="sbu" class="form-label">Sertifikat Badan Usaha</label>
                                    <input type="file" class="form-control noscroll" id="license_sbu" name="license[]"
                                        multiple>
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="telp" class="form-label">Phone number</label>
                                    <input type="number" class="form-control noscroll" id="telp" name="telp">
                                </div>
                            </div>
                            <br>
                            <div class="float-end">
