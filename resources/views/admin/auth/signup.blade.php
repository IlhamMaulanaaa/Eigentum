                                    ...
                                    <form action="/session/signup/create" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input value="{{ Session::get('name') }}"
                                                class="form-control form-control-lg" type="text" id="name" name="name"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input value="{{ Session::get('email') }}"
                                                class="form-control form-control-lg" type="email" id="email" name="email"
