...
class registerController extends Controller
{
    ...
    function store(Request $request)
    {
        ...
        if (Auth::attempt($infologin)) {
            ...
            return redirect('/login/all')->with('success', Auth::user()->name . ' Berhasil Register');
        } else {
            return redirect('/register/all')->withErrors('Username atau Password yang dimasukkan tidak valid !!');
        }
    }
}